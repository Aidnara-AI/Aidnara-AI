...
const requiredFiles = [
  ...
  'fe/src/routes/certificate/[hash].tsx',
...
const requiredTerms = [
  ...
  ['fe/src/routes/verify/certificate/[hash].tsx', ['Verify Certificate', '/api/certificates/hash/', 'demo-certificate-hash', 'testnet.bscscan.com', 'VALID ON-CHAIN', 'NOT FOUND', 'REVOKED', 'Issued:', 'Open certificate file', 'Open printable certificate']],
  ['fe/src/routes/certificate/[hash].tsx', ['Certificate of Impact', 'Transparency Certificate', '/verify/certificate/', 'QR code', 'window.print']],
  ...
  ['be/handlers/proofs.go', ['CreateProof', 'ListProofsByCampaign', 'analyzeProofWithAI', 'GEMINI_API_KEY', 'Missing required proof fields']],
  ['be/handlers/certificates.go', ['CreateCertificate', 'GetCertificateByHash', 'UpdateCertificateTxHash', 'GenerateCertificateHash']],
  ['be/handlers/validation.go', ['validTxHash', 'strings.HasPrefix(value, "0x")', '0123456789abcdefABCDEF']],
