...
const requiredTerms = [
  ...
  ['fe/src/routes/verify/certificate/[hash].tsx', ['Verify Certificate', '/api/certificates/hash/', 'demo-certificate-hash', 'testnet.bscscan.com', 'VALID ON-CHAIN', 'NOT FOUND', 'REVOKED', 'Issued:', 'Open certificate file']],
