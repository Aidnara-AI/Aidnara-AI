...
const requiredTerms = [
  ...
  ['be/package.json', ['check', 'typecheck', '@supabase/supabase-js']],
  ...
  ['be/src/runtime/certificates.ts', ['generateAndStoreCertificate', 'lookupCertificateFromSupabase', 'toCertificateVerificationResponse']],
  ['be/src/runtime/donations.ts', ['createDonationRuntime', 'listDonationsRuntime', 'linkDonationCertificateRuntime']],
  ['be/src/runtime/impact-report.ts', ['createImpactReportWithGemini', 'callGeminiJson']],
  ['be/src/runtime/proofs.ts', ['createProofRuntime', 'Only campaign owner can submit proof', 'attachProofImpactReportRuntime']],
  ['be/src/runtime/storage.ts', ['prepareSupabaseSignedUpload', 'createSupabaseSignedUpload']],
