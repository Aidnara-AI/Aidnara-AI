...
const requiredTerms = [
  ...
  ['fe/src/routes/campaigns/[id].tsx', ['useParams', 'Campaign API unavailable', 'trust score', '/api/donations', '/api/proofs', '/api/certificates']],
  ...
  ['api/storage.md', ['be/uploads/', 'Static']],
