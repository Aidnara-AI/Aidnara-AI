...
const requiredFiles = [
  ...
  'be/src/lib/hash.ts',
  'be/src/lib/http.ts',
  'be/src/lib/rate-limit.ts',
  'be/src/lib/requests.ts',
  'be/src/lib/supabase-admin.ts',
  'be/src/lib/validate.ts',
  'be/src/repositories/campaigns.ts',
  'be/src/repositories/certificates.ts',
  'be/src/repositories/donations.ts',
  'be/src/repositories/proofs.ts',
  'be/src/repositories/types.ts',
  'be/src/runtime/campaigns.ts',
  'be/src/runtime/certificates.ts',
  'be/src/runtime/donations.ts',
  'be/src/runtime/impact-report.ts',
  'be/src/runtime/onchain.ts',
  'be/src/runtime/onchain-sync.ts',
  'be/src/runtime/proofs.ts',
  'be/src/runtime/storage.ts',
  'be/src/services/ai-provider.ts',
  'be/src/services/ai-impact-report.ts',
  'be/src/services/certificate.ts',
  'be/src/services/onchain.ts',
  'be/src/services/onchain-events.ts',
  'be/src/services/storage.ts',
  'be/src/services/supabase-storage.ts',
  'be/src/routes/ai-impact-report.ts',
  'be/src/routes/certificate-lookup.ts',
  'be/src/routes/certificates.ts',
  'be/src/routes/storage.ts',
  'be/src/index.ts',
...
const requiredTerms = [
  ...
  ['be/package.json', ['check', 'typecheck', '@supabase/supabase-js', 'ethers']],
  ['be/tsconfig.json', ['strict', 'outDir']],
  ['be/self-check.js', ['BE self-check passed', 'stableJsonHash']],
  ['be/src/repositories/campaigns.ts', ['createCampaign', 'getCampaignById', 'listCampaigns', 'updateCampaignTrustScore']],
  ['be/src/repositories/proofs.ts', ['createProof', 'listProofsByCampaign', 'updateProofImpactReport']],
  ['be/src/repositories/certificates.ts', ['createCertificate', 'getCertificateByHash']],
  ['be/src/repositories/donations.ts', ['createDonation', 'listDonationsByCampaign', 'linkDonationCertificate']],
  ['be/src/lib/rate-limit.ts', ['assertRateLimit', 'backendRateLimits', 'in-memory best-effort']],
  ['be/src/lib/requests.ts', ['parseImpactReportRequest', 'parseCertificateGenerateRequest', 'parseSignedUploadRequest', 'parseCreateCampaignRequest', 'parseCreateProofRequest', 'parseCreateDonationRequest']],
  ['be/src/lib/supabase-admin.ts', ['createSupabaseAdmin', 'supabaseServiceRoleKey']],
  ['be/src/runtime/campaigns.ts', ['createCampaignRuntime', 'listCampaignsRuntime', 'attachCampaignChainDataRuntime']],
  ['be/src/runtime/certificates.ts', ['generateAndStoreCertificate', 'lookupCertificateFromSupabase', 'backendRateLimits.certificate']],
  ['be/src/runtime/donations.ts', ['createDonationRuntime', 'listDonationsRuntime', 'linkDonationCertificateRuntime']],
  ['be/src/runtime/impact-report.ts', ['createImpactReportWithGemini', 'callGeminiJson', 'backendRateLimits.aiReport']],
  ['be/src/runtime/onchain.ts', ['validateDonationTransactionRuntime', 'validateProofTransactionRuntime', 'validateCertificateTransactionRuntime']],
  ['be/src/runtime/onchain-sync.ts', ['syncAidnaraEventsRuntime', 'listAidnaraEvents']],
  ['be/src/runtime/proofs.ts', ['createProofRuntime', 'Only campaign owner can submit proof', 'backendRateLimits.proof', 'attachProofImpactReportRuntime']],
  ['be/src/runtime/storage.ts', ['prepareSupabaseSignedUpload', 'createSupabaseSignedUpload', 'backendRateLimits.upload']],
  ['be/src/services/ai-provider.ts', ['callGeminiJson', 'parseJsonText', 'responseMimeType']],
  ...
  ['be/src/services/onchain.ts', ['validateDonationEvent', 'validateProofEvent', 'validateCertificateEvent', 'DonationReceived']],
  ['be/src/services/onchain-events.ts', ['listAidnaraEvents', 'IndexedAidnaraEvent', 'normalizeArgs']],
  ['be/src/services/storage.ts', ['validateProofUpload', 'buildStoragePath']],
  ['be/src/services/supabase-storage.ts', ['createSupabaseSignedUpload', 'campaign-covers', 'proofs', 'certificates']],
  ['be/src/routes/ai-impact-report.ts', ['handleCreateImpactReport']],
  ['be/src/routes/certificates.ts', ['handleGenerateCertificate']],
  ['be/src/routes/certificate-lookup.ts', ['lookupCertificate']],
  ['be/src/routes/storage.ts', ['prepareSignedUpload']],
